...
abstract class BaseAccounts extends Doctrine_Record
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('password', 'string', 34, array(
             'type' => 'string',
             'length' => 34,
             'fixed' => false,
             'primary' => false,
        ...
        $this->hasColumn('pseudo', 'string', 64, array(
             'type' => 'string',
             'length' => 64,
             'fixed' => false,
             'primary' => false,
        ...
        $this->hasColumn('login', 'timestamp', null, array(
             'type' => 'timestamp',
             'primary' => false,
             'notnull' => false,
             'autoincrement' => false,
        ...
        $this->hasColumn('group_bit', 'string', 1, array(
             'type' => 'string',
             'length' => 1,
             'fixed' => true,
             'primary' => false,
        ...
        $this->hasColumn('spec_message', 'string', 255, array(
             'type' => 'string',
             'length' => 255,
             'fixed' => false,
             'primary' => false,
        ...
        $this->hasColumn('grad_year', 'string', 4, array(
             'type' => 'string',
             'length' => 4,
             'fixed' => false,
             'primary' => false,
        ...
        $this->hasColumn('edit_cols', 'integer', 1, array(
             'type' => 'integer',
             'length' => 1,
             'unsigned' => 1,
             'primary' => false,
        ...
        $this->hasColumn('edit_rows', 'integer', 1, array(
             'type' => 'integer',
             'length' => 1,
             'unsigned' => 1,
             'primary' => false,
        ...
        $this->hasColumn('webview', 'string', 1, array(
             'type' => 'string',
             'length' => 1,
             'fixed' => true,
             'primary' => false,
        ...
        $this->hasColumn('notes_asc', 'string', 1, array(
             'type' => 'string',
             'length' => 1,
             'fixed' => true,
             'primary' => false,
        ...
        $this->hasColumn('user_type', 'string', 128, array(
             'type' => 'string',
             'length' => 128,
             'fixed' => false,
             'primary' => false,
        ...
        $this->hasColumn('show_images', 'integer', 1, array(
             'type' => 'integer',
             'length' => 1,
             'unsigned' => 0,
             'primary' => false,
        ...
        $this->hasColumn('guest_password', 'string', 30, array(
             'type' => 'string',
             'length' => 30,
             'fixed' => false,
             'primary' => false,
