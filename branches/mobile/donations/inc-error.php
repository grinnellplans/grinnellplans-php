...
function showerror()
{
	if (mysql_errno() || mysql_error()) trigger_error("MySQL error: " . mysql_errno() . " : " . mysql_error(), E_USER_ERROR);
	else trigger_error("Could not connect to DBMS", E_USER_ERROR);
}
...
function errorHandler($errno, $errstr, $errfile, $errline)
{
	...
	case E_COMPILE_ERROR:
		...
		if (session_is_registered("order_no")) session_unregister("order_no");
