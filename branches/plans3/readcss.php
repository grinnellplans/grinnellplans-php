...
'%a %M %D %Y, %l:%i %p'),plan,webview", "accounts", "userid", $searchnum)) //get all of persons plan info
{
	...
	if (!$idcookie && $planinfo[0][5] != 1) {
		...
		echo "<span id=\"plan\"of><span id=\"planoflabel\">Username: </span><span id=\"planofvalue\">" . $planinfo[0][0] . "</span></span>";
		...
		echo "<span id=\"planname\"><span id=\"plannamelabel\">Name:</span><span id=\"plannamevalue\"><u>" . $planinfo[0][1] . "</u></span></div><div id=\"plancontent\">";
