...
<Form action="<?=$panel->fingerbox->action?>" method="<?=$panel->fingerbox->method?>">
<?
...
?>
<table><tr><td><p class="main">Username: </p></td><td><b><?=$plan->username?></b></td></tr></table><table><tr><td><p class="main2">Last login: </p></td><td><?=$plan->lastlogin?></td></tr></table><table><tr><td><p class="main3">Updated on: </p></td><td><?=$plan->lastupdate?></td></tr></table><table><tr><td><p class="main4">Name:</p></td><td><u><?=$plan->planname?></u></td></tr></table><p class="sub">
<?
print($plan->text);
?>
	</p>
...
?>
		<form action="<?=$box->action?>" method="<?=$box->method?>" id="editform" name="editform">
		<textarea rows="<?=$box->rows?>" cols="<?=$box->columns?>" 
