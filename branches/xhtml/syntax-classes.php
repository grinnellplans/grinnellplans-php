...
class Widget {
	...
	function toHTML() {
		...
		return "Warning: toHTML() has been called on an object that ".
			"does not provide it. Please report this as a bug.";
	}
}
...
class FormItem {
	...
	public function toHTML() {
		...
		case 'widget':
			...
			break;
		case 'textarea':
			$str = $str . "<textarea name=\"$this->name\">" .
			   $this->description . '</textarea>';
			break;
		case 'radio':
		case 'checkbox':
			$str = $str . "<input type=\"$this->type\" name=\"$this->name\"" .
			   "value=\"$this->value\"".(($this->checked)?' checked':'').">$this->description";
			break;
		default:
...
class HeadingText extends Text { //TODO decide if we need this or are going with built-in titles instead
