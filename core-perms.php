...
if ($status && $status == 'write-only') {
    ...
    if ($write_only_access[$php_self] || (($php_self == 'search.php') && (isset($_GET['mysearch'])) && ($_GET['mysearch'] == User::name())) || (('read.php' === $php_self) && (isset($_GET['searchname'])) && ($_GET['searchname'] == User::name() && (isset($_GET['edit_submit'])) && ($_GET['edit_submit'] == 1) && (not isset($_GET['searchnum']))))) {
        // Okay
