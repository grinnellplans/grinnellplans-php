...
if (!User::logged_in()) {
    ...
    $arr = array('Change Password' => "changepassword.php", 'Change Name' => "changename.php", 'Guest Readable' => "webview.php", 'Customize' => '', 'Interfaces' => "interfaces.php", 'Styles' => "styles.php", 'Edit Text Box Size' => "textbox.php", 'Optional Links' => "links.php");
