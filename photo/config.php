...
*/
$gallery->setConfig('setup.password', 'Slopin3y');
/*
...
*/
$gallery->setConfig('data.gallery.base', '/title/g2data/grinnellplans.com/');
/*
...
$storeConfig['username'] = 'gallery2u';
$storeConfig['password'] = 'Smokneil1';
$storeConfig['tablePrefix'] = 'g2_gplans_';
...
*/
$gallery->setConfig('galleryBaseUrl', 'http://collegeofgrinnell.com/gallery2/');
/*
