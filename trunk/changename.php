...
{
	mdisp_begin($dbh,$idcookie,$HTTP_HOST . $REQUEST_URI,$myprivl);//begin logged in user display
	...
	<input type="text" name="user_name" value="<?php echo $old_name; ?>">
		...
		mdisp_end($dbh,$idcookie,$HTTP_HOST . $REQUEST_URI,$myprivl);//end logged in user display
	}//if is a valid user
db_disconnect($dbh);
?>
