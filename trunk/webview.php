...
else //allowed to edit
{
	...
	{ 
		...
		<table><tr><Td>Preference set.</td></tr></table></center><?
	...
	else
	{
		...
		echo "<tr><td><input type=\"radio\" name=\"webview\" value=\"\" " . 
		$unviewable . ">Make plan unviewable to guests.</td></tr>";
